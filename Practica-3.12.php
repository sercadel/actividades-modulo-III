...
// Convierte a cadena el array obtenido de la función codificar
$fraseCodificada = implode("", codificar($fraseOriginal, $desplazamiento));

// Convierte a cadena el array obtenido de la función decodificar
$fraseDecodificada = implode("", decodificar($fraseCodificada, $desplazamiento));
...
echo "Frase original: " . $fraseOriginal
    ...
    . "<br>
    Frase códificada: " . $fraseCodificada
    . "<br><br>
    Frase decódificada: " . $fraseDecodificada;
